...
const createJson =  require("./JsonHandler");
...
async function PdfToJson(files){
      ...
      try {
        ...
        let outputFilePath =
          "ExtractedZip/ExtractTextTableWithTableStructure/extract"+file+".pdf";
        ...
        //Unziping the extracted Ziped folder
        await unzip.unzip(file);

        //Extracting data and storing in Products.json
        await createJson.createJSON(file);  
